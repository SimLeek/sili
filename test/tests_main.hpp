 ...
 *
 * Determines if a type is `std::vector<T>` or `sili::unique_vector<T>`, inheriting
...
/**
 * @brief Specialization for sili::unique_vector.
 */
...
/**
 * @brief Streams a sili::unique_vector to an ostream.
 *
 * @tparam Ch Character type of the stream.
 * @tparam Tr Traits type of the stream.
 * @tparam T Type of the vector elements.
 * @param o The output stream.
 * @param p The unique_vector to stream.
 * @return The output stream.
 */
template <class Ch, class Tr, class T>
